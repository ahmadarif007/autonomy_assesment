                            ...
                            <div class="col-6 col-md-4 col-lg-4 col-xl-3">
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{'files/'. $row->thumbnail}}" alt="Product image" class="product-image">
                                        </a>
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-title"><a href="{{ route('product.details',$row->slug) }}">{{$row->name}}</a></h3><!-- End .product-title -->
